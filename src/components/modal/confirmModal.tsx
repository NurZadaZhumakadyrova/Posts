          ...
          <div className="relative">
            <DialogHeader className="p-6 pb-4">
              <div className="flex flex-col items-center mb-4">
                ...
                <DialogTitle className="text-2xl font-bold text-center text-white mb-2">
                  ...
                  {type === 'album' && 'Delete Album?'}
                  {type === 'photo' && 'Delete Photo?'}
                </DialogTitle>
              </div>
              <DialogDescription className="text-white/70 text-center text-base leading-relaxed">
                {type === 'post' && 'This action cannot be undone. This post will be permanently deleted from the system.'}
                {type === 'task' && 'This action cannot be undone. This task will be permanently deleted from the system.'}
                {type === 'album' && 'This action cannot be undone. This album will be permanently deleted from the system.'}
                {type === 'photo' && 'This action cannot be undone. This photo will be permanently deleted from the system.'}
              </DialogDescription>
            </DialogHeader>
            <DialogFooter className="p-6 pt-4 border-t border-white/10 flex gap-3 justify-center sm:justify-center">
              ...
              <Button
                ...
                disabled={postLoading || taskLoading || albumLoading || photoLoading}
              ...
              >
                {(postLoading || taskLoading || albumLoading || photoLoading) ? (
